...
if __name__=='__main__':
    ...
    model_save_dir = current_directory / 'Checkpoints' / 'genome_text_learnable_emb' / 'guaidance_regressor'
    ...
    # 创建文件Handler
    file_handler = logging.FileHandler(model_save_dir/f'log_guaidance_regressor.log', mode='w')
      ...
      Text onlyTrain pearson:{t_pearson_train:.4f}""")
                ...
                if r2_train > best_R2_test:
                    ...
                    torch.save({
                        ...
                        model_save_dir / f'guaidance_best_R2_all_peptide_epoch_{num_epochs}.pth')
